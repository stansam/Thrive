    ...
    const handleUpdateBooking = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "The package booking status has been updated.",
            });
        } catch (error: any) {
    ...
    const handleCancelBooking = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "The package booking has been successfully cancelled.",
            });
        } catch (error: any) {
        ...
        <div className="space-y-4">
            ...
            <Card>
                <CardHeader className="px-6 py-4 border-b">
                    ...
                    <CardDescription>
                        Manage travel package reservations.
                    </CardDescription>
                </CardHeader>
                                    ...
                                    <TableRow key={booking.id}>
                                        ...
                                        <TableCell>
                                            <div className="flex flex-col gap-1 text-sm">
                                                <span className="font-medium">{booking.package?.name || "Custom Package"}</span>
                                                <div className="text-xs text-muted-foreground">{booking.destination || "Unknown Destination"}</div>
                                            </div>
                                        </TableCell>
                                        <TableCell>
            ...
            <Dialog open={!!selectedBookingId} onOpenChange={() => setSelectedBookingId(null)}>
                <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>Package Booking Details</DialogTitle>
                        <DialogDescription>
                    ...
                    {loadingBooking ? (
                        ...
                        <div className="space-y-6">
                            ...
                            {/* PackageSpecific Info */}
                            <div className="border-t pt-4">
                                <h4 className="font-semibold mb-3">Package Details</h4>
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <Label className="text-muted-foreground">Package Name</Label>
                                        <p className="font-medium">{selectedBooking.package?.name || "Custom"}</p>
                                    </div>
                                    <div>
                                        <Label className="text-muted-foreground">Duration</Label>
                                        <p className="font-medium">{selectedBooking.package?.duration || "N/A"}</p>
                                    </div>
                                </div>
                            </div>
            ...
            <AlertDialog open={!!cancelBookingId} onOpenChange={() => setCancelBookingId(null)}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>Cancel Package Booking</AlertDialogTitle>
                        <AlertDialogDescription>
                            Are you sure you want to cancel this booking? This might involve refund calculations.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <div className="py-4">
                        ...
                        <Textarea
                            id="cancel-reason"
                            placeholder="e.g., Customer request, package unavailable..."
                            value={cancelReason}
